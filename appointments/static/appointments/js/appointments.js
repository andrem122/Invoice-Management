$(function() {
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', fill_in_city);
  ...
  function fill_in_city() {
    // Fills in the city fields when the user
    ...
    for (var i = 0; i < l; i++) {
      ...
      // Get the city from the google place object
