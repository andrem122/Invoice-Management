...
def send_confirmation_notification(appointment_object):
...
def incoming_sms(request):
    ...
    # Appointment object found and appointment confirmed
        ...
        response_message = (
        'Hello {name}, your appointment at {time} has been confirmed. '
    ...
    # Appointment object found and appointment canceled
        ...
        'an appointment, you can do so by going online at https://www.novaonesoftware.com/appointments/new.'
        + end_of_reponse_message
        )
